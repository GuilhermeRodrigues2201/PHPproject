...
<body>
    <div class="dashboard-container">
        ...
        <div class="quick-actions">
            <button class="action-btn"><a href="../funcionarios/alterarFunc.php">Alterar informações</a></button>
            <button class="action-btn"><a href="listaProdutos.php">Controle de Estoque</a></button>
        </div>
